## 0.3.0 - 28th November 2023

### Features

- Index page showing you a quick overview of your Figma document and improving load times
- Focus mode which allows you to focus on the frame you are building
...
- You can exit focus mode to get back to the full canvas view using the icon in the toolbar
